/******/ (() => {
  ...
  \********************************/
      /***/ (
        ...
        /* harmony import */ var _states_js__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./states.js */ "./src/js/states.js");

        function appNumber(num) {
          if (
            num === "," &&
            _states_js__WEBPACK_IMPORTED_MODULE_0__.allState.currentOp.indexOf(
              ",",
            ) > -1
          )
            return;
          if (
            _states_js__WEBPACK_IMPORTED_MODULE_0__.allState.currentOp ===
              "0" &&
            num != ","
          )
  ...
  \*****************************/
      /***/ (
        ...
        function calculate() {
          let reasult = 0;
          let prev = parseFloat(
            _states_js__WEBPACK_IMPORTED_MODULE_0__.allState.prevOperation.replaceAll(
              ",",
              ".",
            ),
          );
          let current = parseFloat(
            _states_js__WEBPACK_IMPORTED_MODULE_0__.allState.currentOp.replaceAll(
              ",",
              ".",
            ),
          );
          ...
          (0, _states_js__WEBPACK_IMPORTED_MODULE_0__.updateStates)({
            currentOp:
              reasult % 1 == 0 ? reasult.toFixed(0) : reasult.toFixed(5),
            operation: "",
            prevOperation: "",
          });
        }
  ...
  \**********************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ checkOperation: () =>
            /* binding */ checkOperation,
          /* harmony export */
        });
        /* harmony import */ var _calculate_js__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./calculate.js */ "./src/js/calculate.js");
        /* harmony import */ var _states_js__WEBPACK_IMPORTED_MODULE_1__ =
          __webpack_require__(/*! ./states.js */ "./src/js/states.js");

        function checkOperation(operation) {
          if (
            _states_js__WEBPACK_IMPORTED_MODULE_1__.allState.currentOp === ""
          ) {
            return;
          }
          if (
            _states_js__WEBPACK_IMPORTED_MODULE_1__.allState.prevOperation !==
            ""
          ) {
  ...
  \*************************/
      /***/ (
        ...
        __webpack_require__.r(__webpack_exports__);
        /* harmony export */ __webpack_require__.d(__webpack_exports__, {
          /* harmony export */ clearOperations: () =>
            /* binding */ clearOperations,
          /* harmony export */
        });
        /* harmony import */ var _states_js__WEBPACK_IMPORTED_MODULE_0__ =
          __webpack_require__(/*! ./states.js */ "./src/js/states.js");
      ...
      /***/ (
        ...
        function updateScreen() {
          ...
          let currentText =
            _states_js__WEBPACK_IMPORTED_MODULE_0__.allState.currentOp;
          let prevText =
            _states_js__WEBPACK_IMPORTED_MODULE_0__.allState.prevOperation;
          ...
          test.innerText =
            _states_js__WEBPACK_IMPORTED_MODULE_0__.allState.prevOperation +
            _states_js__WEBPACK_IMPORTED_MODULE_0__.allState.operation;
        }
...
*/
  ...
  \**********************/
    ...
    /* harmony import */ var _js_appendNumber_js__WEBPACK_IMPORTED_MODULE_1__ =
      __webpack_require__(
        /*! ./js/appendNumber.js */ "./src/js/appendNumber.js",
      );
    /* harmony import */ var _js_calculate_js__WEBPACK_IMPORTED_MODULE_2__ =
      __webpack_require__(/*! ./js/calculate.js */ "./src/js/calculate.js");
    /* harmony import */ var _js_checkOperation_js__WEBPACK_IMPORTED_MODULE_3__ =
      __webpack_require__(
        /*! ./js/checkOperation.js */ "./src/js/checkOperation.js",
      );
    /* harmony import */ var _js_clear_js__WEBPACK_IMPORTED_MODULE_4__ =
      __webpack_require__(/*! ./js/clear.js */ "./src/js/clear.js");
    /* harmony import */ var _js_states_js__WEBPACK_IMPORTED_MODULE_5__ =
      __webpack_require__(/*! ./js/states.js */ "./src/js/states.js");
    /* harmony import */ var _js_updateScreen_js__WEBPACK_IMPORTED_MODULE_6__ =
      __webpack_require__(
        /*! ./js/updateScreen.js */ "./src/js/updateScreen.js",
      );
    ...
    window.addEventListener("load", () => {
      ...
      plusMinus.addEventListener("click", () => {
        (0, _js_states_js__WEBPACK_IMPORTED_MODULE_5__.updateStates)({
          currentOp: String(
            parseFloat(
              _js_states_js__WEBPACK_IMPORTED_MODULE_5__.allState.currentOp,
            ) * -1,
          ),
        });
      ...
      operations.forEach((elem) => {
        elem.addEventListener("click", (e) => {
          ...
          (0,
          _js_checkOperation_js__WEBPACK_IMPORTED_MODULE_3__.checkOperation)(
            operation,
          );
          (0, _js_updateScreen_js__WEBPACK_IMPORTED_MODULE_6__.updateScreen)();
        });
